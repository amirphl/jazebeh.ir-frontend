    ...
    async (resume = false) => {
      ...
      try {
        ...
        if (
          ...
          // A current exact-capacity result proves the selection was already
          // saved before that calculation started. Re-saving an identical
          // selection here is not harmless: the API may advance the campaign
          // revision, causing the execution job to report CAMPAIGN_CHANGED.
          // Dirty selections cannot reach this point because they invalidate
          // the exact-capacity prerequisite above.
          if (initialCampaign.segment.smartTargetingSelectionDirty === true) {
            persist(null, 'saving');
