...
const bundlesFa: BundlesCopy = {
  ...
  detailPage: {
    ...
    actionData: {
      title: 'داده‌های اکشن',
      description:
        'فایل‌های اکشن را بارگذاری کرده و گزارش ATR تجمعی را مشاهده کنید.',
      ...
      delete: 'حذف',
      deleteConfirm:
        'این فایل اکشن پردازش‌شده حذف شود؟ معیارها تا پایان حذف باقی می‌مانند.',
      ...
      fileTooLarge: 'حجم فایل اکشن باید حداکثر ۵۰ مگابایت باشد.',
      uploadFailed: 'بارگذاری فایل اکشن ناموفق بود.',
      loadFailed: 'دریافت داده‌های اکشن ناموفق بود.',
      deleteFailed: 'حذف فایل اکشن ناموفق بود.',
